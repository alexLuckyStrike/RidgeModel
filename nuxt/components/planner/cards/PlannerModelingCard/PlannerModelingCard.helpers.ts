...
// Стратегия 5: Вариативная
//
// Использует все три параметра одновременно. Распределение между
// параметрами выводится из их стандартных отклонений в обучающей
// выборке - каждый параметр работает в своём типичном масштабе.
//
// Никаких введённых констант. Только β из модели и σ из обучающих
// данных.
//
// Два режима:
//   Нагрузочный (target >= 0):
//     V↑, P↑, R↑ - R удлиняется как компенсация (через отрицательный β_R)
//   Восстановительный (target < 0):
//     V↓, P↓, R↑ - R удлиняется как подкрепление разгрузки
//
// В обоих режимах R удлиняется.
